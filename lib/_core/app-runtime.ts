/**
 * App Runtime - Communication layer between Expo web app and parent preview container
 *
 * Flow:
...
/**
 * Initialize App Runtime - notifies preview parent container that app is ready
 */
